function [arParam,maParam,residuals,noiseSigma,errFlag] = ARMA_HR_ACF(traj,arParamI,trajLength,arOrder,maOrder)
...
%arParamI = AR_YW(traj,arOrderI)';

arOrderI = numel(arParamI); 

...
for TempTreMethod in ${TempTreMethodLIST[@]};do
        ...
        for METH_ID in ${METHODLIST[@]}; do
			...
			ConDir="/well/nichols/users/scf915/${COHORT}/R.PW/${COHORT}_${TR}_${T}_${TaskName}_${METH_ID}_AR-${ARO}_MA-0_FWHM${FWHMsize}_${TempTreMethod}_gsr0_aroma0"
					...
					wVDIR=${SubDIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_wvc_ICACLEAN0_GSR0.nii.gz
...
#					echo $InDir
			...
			${FSLDIR}/bin/fslmerge \
			-t  ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_cbhat_4D \
			${ConDir}/*_*/mni/*_cbhat_ICACLEAN0_GSR0_mni.nii.gz
			echo "4D data is: ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_cbhat_4D"

			${FSLDIR}/bin/fslmerge \
			-t  ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_Wcbhat_4D \
			${ConDir}/*_*/mni/*_Wcbhat_ICACLEAN0_GSR0_mni.nii.gz
                        echo "4D data is: ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_Wcbhat_4D"

                        ${FSLDIR}/bin/fslmerge \
                        -t  ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_wvc_4D \
                        ${ConDir}/*_*/mni/*_wvc_ICACLEAN0_GSR0_mni.nii.gz
                        echo "4D data is: ${LEVEL2DIR}/ED${EDtype}_${METH_ID}_AR${ARO}_MA0_FWHM${FWHMsize}_${TempTreMethod}${TempTrendP[$tr_cnt]}_wvc_4D"
